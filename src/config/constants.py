...
PROJECT_NAME = "worldbank-etl"
VERSION = "1.0.0"

# Lista usada na limpeza dos indicadores e do GDP
NON_COUNTRIES = [
    ...
    'Euro area', 'Early-demographic dividend', 'Lower middle income',
    ...
    'Middle East & North Africa', 'Europe & Central Asia (excluding high income)',
    'South Asia (IDA & IBRD)', 'South Asia', 'Arab World', 'IDA total',
    ...
    'Low income','Small states','Other small states','Not classified',
